...
// Static data
const categories = [
  { id: 1, name: 'Wildlife Safari', icon: '🦁', color: '#EDAE49', bgColor: '#EDAE49/10' },
  { id: 2, name: 'Beach Getaway', icon: '🏖️', color: '#00798C', bgColor: '#00798C/10' },
  { id: 3, name: 'Cultural Experience', icon: '🗿', color: '#30638E', bgColor: '#30638E/10' },
  { id: 4, name: 'Adventure', icon: '⛰️', color: '#D1495B', bgColor: '#D1495B/10' },
];
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredServices.map(service => (
              <ServiceCard 
                key={service.id} 
                {...service} 
                onManage={() => console.log('View service:', service.id)}
              />
            ))}
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-[#003D5B] to-[#30638E] rounded-2xl p-8 text-center">
          ...
          <Button variant="primary" size="lg" className="bg-[#EDAE49] text-[#003D5B] hover:bg-[#e5a23e]">
            Get Started →
          </Button>
        </section>
